...
import HomeView from '../views/InicialView.vue'
...
const routes = [
  ...
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "about" */ '../views/SobreNosView.vue')
    }
  }, 
  {
    path: '/meu-perfil',
  ...
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "about" */ '../views/EbooksView.vue')
    }
  },
  {
    path: '/pagamento',
    ...
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "about" */ '../views/PagamentoView.vue')
    }
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "about" */ '../views/PagamentoSucesso.vue')
    }
  },
]
